var leftContents = [
  ...
  },
  {
    ...
    company: "Gcalls",
    time: "June 2021 - September 2021 - 3 months",
    jobType: "Online",
    content:
  ...
  },
  {
    catagories: "PROJECTS",
    position: "Rent 4.0",
    company: "app.renteverything.online",
    time: "February 2021 -  June 2021",
    content:
      "Web and mobile application using modern tech-stack ( NextJS, React Native, GraphQL, NGINX, Docker, PostgreSQL ), which helps other people to rent something in real-time. The project was written in TypeScript with NextJS Framework working with NodeJS backend, and PostgreSQL database. In addition, Redis was used to cache data and NGINX was applied as a web server and reverse proxy. The website was encrypted with SSL/TLS through Let’s Encrypted Certificate. ",
  },
];
...
var rightContents = [
  {
    title: "Contact",
    contents: ["tus.phananh@gmail.com", "+84932059267", "Ho Chi Minh City"],
  },
  {
  ...
  },
  {
    ...
    contents: ["JavaScript, TypeScript, Java, Python, Swift."],
  },
  {
    title: "Other Skills",
    contents: ["Video and Photo Editing."],
  },
  {
    title: "Languages",
    contents: [
  ...
  },
  {
    ...
    contents: ["Professional Scrum Master I (Scrum.org)"],
  },
];
